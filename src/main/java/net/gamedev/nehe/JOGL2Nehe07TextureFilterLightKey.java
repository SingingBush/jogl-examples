...
public class JOGL2Nehe07TextureFilterLightKey extends GLCanvas implements GLEventListener, KeyListener {
    ...
    private static final String TEXTURE_FILE_NAME = "images/crate.png";
    ...
    public void init(GLAutoDrawable drawable) {
        ...
        try {
            ...
            BufferedImage image =
                    ImageIO.read(getClass().getClassLoader().getResource(TEXTURE_FILE_NAME));
