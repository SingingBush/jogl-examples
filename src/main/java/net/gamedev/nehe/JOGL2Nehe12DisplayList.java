...
public class JOGL2Nehe12DisplayList implements GLEventListener, KeyListener {
    ...
    private static final String TITLE = "NeHe Lesson #12: Display Lists";  // window's title
    ...
    private static final String TEXTURE_FILE_NAME = "images/Cube.bmp";
    ...
    public void init(GLAutoDrawable drawable) {
        ...
        try {
            ...
            texture = TextureIO.newTexture(
                    this.getClass().getClassLoader().getResource(TEXTURE_FILE_NAME), false, BMP_FILE_TYPE);
        } catch (GLException e) {
            e.printStackTrace();
        } catch (IOException e) {
            e.printStackTrace();
