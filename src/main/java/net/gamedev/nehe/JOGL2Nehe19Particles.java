...
public class JOGL2Nehe19Particles implements GLEventListener, KeyListener {
    ...
    private static final String TITLE = "NeHe Lesson #19: Particle Engine Using Triangle Strips";
    ...
    private static final String TEXTURE_FILE_NAME = "images/particle.png";
...
//      gl.glDepthFunc(GL_LEQUAL);  // the type of depth test to do
        ...
        try {
            ...
            texture = TextureIO.newTexture(
                    this.getClass().getClassLoader().getResource(TEXTURE_FILE_NAME), false, PNG_FILE_TYPE);
