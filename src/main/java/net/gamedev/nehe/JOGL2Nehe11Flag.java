...
public class JOGL2Nehe11Flag implements GLEventListener {  // Renderer
    ...
    private static final String TITLE = "NeHe Lesson #11: Flag Effect (Waving Texture)";
    ...
    private static final String TEXTURE_FILE_NAME = "images/tim.png";
...
//   private float textureRight;
    ...
    public void init(GLAutoDrawable drawable) {
        ...
        try {
            ...
            texture = TextureIO.newTexture(this.getClass().getClassLoader().getResource(TEXTURE_FILE_NAME), false, textureFileType);
        } catch (GLException e) {
            e.printStackTrace();
        } catch (IOException e) {
            e.printStackTrace();
