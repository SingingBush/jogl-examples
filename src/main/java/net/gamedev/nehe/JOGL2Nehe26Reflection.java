...
public class JOGL2Nehe26Reflection implements GLEventListener, KeyListener {
    ...
    private static final String TITLE = "Nehe #26: Clipping & Reflections Using The Stencil Buffer";
    ...
    private static final String[] TEXTURE_FILE_NAMES = { "images/envwall.jpg", "images/ball.jpg", "images/envroll.jpg" };
    ...
    public void init(GLAutoDrawable drawable) {
        ...
        try {
            for (int i = 0; i < textures.length; i++) {
                textures[i] = TextureIO.newTexture(this.getClass().getClassLoader().getResource(TEXTURE_FILE_NAMES[i]), false, JPG_FILE_TYPE);
